...
func (r *rosClient) Finds(client *routeros.Client, params *domain.SimpleQueue) (res []domain.SimpleQueue, err error) {
	result, err := client.Run("/queue/simple/print", "=.proplist=.id,name,target,packet-marks,max-limit")
	if err != nil {
		return nil, err
	}
...
func (r *rosClient) Firsts(client *routeros.Client, param *domain.SimpleQueue) (res domain.SimpleQueue, err error) {
	result, err := client.Run("/queue/simple/print", "=.proplist=.id,name,target,packet-marks,max-limit")
	if err != nil {
		return
	}
...
func (r *rosClient) Saves(client *routeros.Client, param *domain.SimpleQueue) (err error) {
...
func (r *rosClient) Updates(client *routeros.Client, param *domain.SimpleQueue) (err error) {
	params := make([]string, 0)
...
func (r *rosClient) Deletes(client *routeros.Client, params *domain.SimpleQueue) (err error) {
	id := "=.id=" + params.ID
	_, err = client.Run("/queue/simple/remove", id)

...
func (r *rosClient) Finds(client *routeros.Client, params *domain.Firewall) (res []domain.Firewall, err error) {
	result, err := client.Run("/ip/firewall/mangle/print", "=.proplist=.id,chain,action,new-connection-mark,passthrough,src-mac-address,connection-mark,new-packet-mark")
	if err != nil {
		return nil, err
	}
...
func (r *rosClient) Firsts(client *routeros.Client, param *domain.Firewall) (res domain.Firewall, err error) {
...
func (r *rosClient) Saves(client *routeros.Client, param *domain.Firewall) (err error) {
...
func (r *rosClient) Updates(client *routeros.Client, param *domain.Firewall) (err error) {
	params := make([]string, 0)
...
func (r *rosClient) Deletes(client *routeros.Client, params *domain.Firewall) (err error) {
	id := "=.id=" + params.ID
	_, err = client.Run("/ip/firewall/mangle/remove", id)
